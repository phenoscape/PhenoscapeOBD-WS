...
public class PublicationTermQueryBuilder extends QueryBuilder {
    ...
    protected String getQuery() {
        ...
        query.append("SELECT publication.node_id, publication.uid, publication.source_id, publication.label, citation.val AS citation_label, abstract.val AS abstract_label, source.uid AS source_uid, source.label AS source_label ");
