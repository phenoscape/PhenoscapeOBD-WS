...
public class TaxonQueryBuilder extends QueryBuilder {
    ...
    protected String getQuery() {
        return "SELECT focal_taxon.*, parent.uid AS parent_uid, parent.label AS parent_label, parent.is_extinct AS parent_is_extinct, parent.rank_node_id AS parent_rank_node_id, parent.rank_uid AS parent_rank_uid, parent.rank_label AS parent_rank_label, source.uid AS source_uid, source.label AS source_label " +
