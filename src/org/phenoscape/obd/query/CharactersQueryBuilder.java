...
public class CharactersQueryBuilder extends QueryBuilder {
    ...
    public CharactersQueryBuilder(TaxonAnnotationsQueryConfig config, boolean totalOnly) {
        this.config = config;
    ...
    protected String getQuery() {
        ...
        if (intersects.isEmpty()) {
            baseQuery = "SELECT DISTINCT queryable_taxon_annotation.character_node_id, queryable_taxon_annotation.character_number, queryable_taxon_annotation.character_label FROM queryable_taxon_annotation ";    
        } else {
    ...
    private String getTaxonQuery(String taxonID) {
        final StringBuffer query = new StringBuffer();
        query.append("(SELECT DISTINCT queryable_taxon_annotation.character_node_id, queryable_taxon_annotation.character_number, queryable_taxon_annotation.character_label FROM queryable_taxon_annotation ");
