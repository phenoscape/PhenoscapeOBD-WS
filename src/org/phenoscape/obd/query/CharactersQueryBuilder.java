...
public class CharactersQueryBuilder extends QueryBuilder {
    ...
    protected String getQuery() {
        ...
        if (intersects.isEmpty()) {
            baseQuery = "SELECT * FROM character ";    
        } else {
    ...
    private String getTaxaQuery(List<String> taxonIDs) {
        ...
        query.append("SELECT * FROM character ");
        query.append("WHERE character.node_id IN ");
        query.append("(");
        query.append("SELECT character_node_id FROM annotation_source ");
