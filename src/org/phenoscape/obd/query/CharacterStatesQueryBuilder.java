...
public class CharacterStatesQueryBuilder extends QueryBuilder {
    ...
    public CharacterStatesQueryBuilder(TaxonAnnotationsQueryConfig config, boolean totalOnly) {
        this.config = config;
    ...
    protected String getQuery() {
        ...
        if (intersects.isEmpty()) {
            baseQuery = "SELECT DISTINCT queryable_taxon_annotation.state_node_id, queryable_taxon_annotation.state_label FROM queryable_taxon_annotation ";    
        } else {
        ...
        if (this.totalOnly) {
            ...
            query = baseQuery + "ORDER BY " + "state_label" + " " + this.getSortText() + "LIMIT ? OFFSET ? " ;
        }
    ...
    private String getTaxonQuery(String taxonID) {
        final StringBuffer query = new StringBuffer();
        query.append("(SELECT DISTINCT queryable_taxon_annotation.state_node_id, queryable_taxon_annotation.state_label FROM queryable_taxon_annotation ");
